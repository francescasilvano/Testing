...
set_scan_configuration -chain_count 18
#the following should be run for a compressor of the scan chain 
#set_scan_compression_configuration -chain_count 50
