...
cd $( dirname $0)
root_dir=${PWD}
our_directory=${PWD}/hw_assignment/syn/output
cd - &>/dev/null
...
vcom -2008 -work work_gate \
${our_directory}/bist_controller.vhd \
${our_directory}/phase_shifter.vhd \
${our_directory}/multiplexer.vhd \
${our_directory}/riscv_top.vhd

vlog -sv -work work_gate -cover t -novopt -timescale "1 ns/ 1 ps"  -suppress 2577 -suppress 2583  \
	${our_directory}/riscv_core_scan.v \
	${our_directory}/lfsr.v \
	${our_directory}/misr.v \
